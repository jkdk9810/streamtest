...
image3 ="https://github.com/jkdk9810/streamtest/blob/main/RESULT1.png?raw=true"
...
dataframe['O3'] = pd.tonumeric(dataframe['o3Value'])
o3 = dataframe['o3Value']
total = dataframe['total']
dust = dataframe['dust']
# # 바차트 올리기
st.title('공공데이터 분석하기')
st.write('한국환경공단에어코리아_대기오염정보의 통합환경수치와 미세먼지를 불러와 분석을 진행합니다.')
